...
import authorsPageInitialPathsA72d0Resource from '../../../resources/authors-page-initial-paths-a72d0'
import authorsPageInitialProps985abResource from '../../../resources/authors-page-initial-props-985ab'
...
export async function getStaticPaths() {
  const response = await authorsPageInitialPathsA72d0Resource({})
...
export async function getStaticProps(context) {
  const response = await authorsPageInitialProps985abResource({
    ...context?.params,
